...
Gibbs Free Energy Change:
    ...
    drGm*(T=298.15 K)=-5608.8 kJ/mol

Thermodynamic Equilibrium Constant:

    Kp*(T=298.15 K)=9.608E+00
...
Reaction Gibbs Free Energy Barrier dG(T=298.15 K):
    ...
    dG(T=298.15 K)=277.4 kJ/mol        

Reaction Rate Constant:

    Gibbs Free Energy Method:

        k(T=298.15 K, GMethod)=4.124E-19 s-1

    Partition Function Method:

        k(T=298.15 K, QMethod)=4.124E-19 s-1

Halflife of Reactant:

    Gibbs Free Energy Method:

        t1/2(T=298.15 K, GMethod)=1.681E+18 s

    Partition Function Method:

        t1/2(T=298.15 K, QMethod)=1.681E+18 s
